#!/usr/bin/env python3
"""Generate Label Studio tasks with normalization guards."""
...
from invoices import normalize, paths
...
def generate_tasks(seed_folder: str, output_dir: str = "tools/labelstudio/output") -> dict:
    """
    Generate Label Studio tasks with normalization guards.
...
def main():
    ...
    try:
        summary = generate_tasks(args.seed_folder, args.output)

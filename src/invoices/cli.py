...
def emit_cmd(
    ...
    feature_version: str | None = typer.Option(None, "--feature-version", help="Override feature version"),
    decoder_version: str | None = typer.Option(None, "--decoder-version", help="Override decoder version"),
    calibration_version: str | None = typer.Option(None, "--calibration-version", help="Override calibration version"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output")
) -> None:
...
def run(
    ...
    output_dir: str = typer.Option("artifacts", "--output", "-o", help="Output directory for JSON results"),
    verbose: bool = typer.Option(False, "--verbose", "-v", help="Verbose output")
) -> None:
